...
HD_PWD='D:/Facultate/Anul II/Sem I/ED/ED proiect/Counter_up_down/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_divizat.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_divizat.tcl -notrace
