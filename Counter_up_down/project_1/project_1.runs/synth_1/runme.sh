...
HD_PWD='D:/Facultate/Anul II/Sem I/ED/ED proiect/Counter_up_down/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_divizat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_divizat.tcl
